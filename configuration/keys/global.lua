...
local globalKeys =
  ...
  awful.key({modkey}, 'r', function() awful.spawn('rofi -combi-modi window,drun -show combi -modi combi') end, {description = 'Rofi Menu', group = 'Awesome'}),
  ...
  awful.key({modkey}, 'e', function() awful.util.spawn(apps.default.files) end, {description = 'Nemo', group = 'Programs'}),
  ...
  {description = 'Previous', group = 'Windows'}),
    ...
    {description = 'Next', group = 'Windows'}
  )
)
